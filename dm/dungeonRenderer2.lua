...
local function DungeonRenderer2(w, h)
	local self = {}
	...
	self.drawLine = function(...)
		--print("Calling drawLine", arg)
		--print("Arg fait ", #arg, " arguments.")
		local V = {}
		...
		for i, v in ipairs(V) do
			print("Drawing line ", v)
			love.graphics.line(v)
		end
		]]--
		love.graphics.line(0,0,self.w, self.h)
	end
	
	self.drawQuad = function(v1, v2, v3, v4)
		--print("Calling drawQuad")
		self.drawLine(v1, v2, v3, v4)
		--print(v1, v2, v3, v4)
	end
	...
	self.drawPerspLines = function()
		...
		for i = 0, 16 do
			...
			i = i * 2 * math.pi / 16
			local v1 = Vec(0,0)
			local v2 = Vec(math.cos(i) * dx, math.sin(i) * dy)
